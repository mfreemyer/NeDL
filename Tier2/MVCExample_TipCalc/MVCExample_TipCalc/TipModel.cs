...
namespace MVCExample_TipCalc
{
    class TipModel
    {
        ...
        /// We are ignoring tax and whether we tip before or after tax. 
        /// The point is the MVC model. 
        ...
        public TipModel()
        {
            Amount = 0; //*** why are first letters capitalized?
            TipPercent = 0; //*** why are first letters capitalized?
        }
        ...
        public double TipPercent
        {
            ...
            set
            {
                ...
                //If it is a whole number larger than 1 we divide it by 100, 
                //so the highest possible tip is 100%.
                if (value > 1)
                {
                    value /= 100;
                }
